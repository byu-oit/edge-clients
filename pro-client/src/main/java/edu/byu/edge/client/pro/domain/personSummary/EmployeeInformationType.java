 ...
 *         &lt;element name="date_hired" type="{uri://byu/c/ry/ae/prod/person_new/cgi/personSummary.cgi}date_hiredType"/>
 *         &lt;element name="retirement_date" type="{http://www.w3.org/2001/XMLSchema}date"/>
 *         &lt;element name="secondary_role" type="{uri://byu/c/ry/ae/prod/person_new/cgi/personSummary.cgi}secondary_roleType"/>
 *         &lt;element name="university_affiliation" type="{uri://byu/c/ry/ae/prod/person_new/cgi/personSummary.cgi}university_affiliationType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class EmployeeInformationType {
    ...
    @XmlElement(name = "job_title", namespace = "uri://byu/c/ry/ae/prod/person_new/cgi/personSummary.cgi", required = true)
    protected String jobTitle;
    @XmlElement(name = "date_hired", namespace = "uri://byu/c/ry/ae/prod/person_new/cgi/personSummary.cgi", required = true)
    protected DateHiredType dateHired;
    @XmlElement(name = "retirement_date", namespace = "uri://byu/c/ry/ae/prod/person_new/cgi/personSummary.cgi", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar retirementDate;
    @XmlElement(name = "secondary_role", namespace = "uri://byu/c/ry/ae/prod/person_new/cgi/personSummary.cgi", required = true)
    protected SecondaryRoleType secondaryRole;
    @XmlElement(name = "university_affiliation", namespace = "uri://byu/c/ry/ae/prod/person_new/cgi/personSummary.cgi", required = true)
